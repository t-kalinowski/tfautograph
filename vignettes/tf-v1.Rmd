...
`autograph()` has complete compatibility with both Tensorflow version 2.0.0+ and 1.15.0+. For the most part, there are no difference between how `autograph()` work in both version, either in eager mode or graph mode. 
