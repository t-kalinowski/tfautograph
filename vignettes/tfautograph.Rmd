...
vignette: >
  %\VignetteIndexEntry{Getting Started with tfautograph}
...
produced function graph from a temporary directory. Note, the function must be being traced for the first time for `view_function_graph` to succeed.

```{r, eval = FALSE}
view_function_graph(tf_function(fizzbuzz), list(tf$constant(25L)))
```
```{r, echo=FALSE, fig.cap="FizzBuzz Graph in Tensorboard", out.width = '100%'}
