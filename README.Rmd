...
[![Travis build status](https://travis-ci.com/t-kalinowski/tfautograph.svg?branch=master)](https://travis-ci.com/t-kalinowski/tfautograph)
<!-- badges: end -->
...
+  Full [MNIST training loop](https://t-kalinowski.github.io/tfautograph/articles/demo-mnist.html) using `autograph` and Tensorflow 2.
