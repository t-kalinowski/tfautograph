...
Additional remaining tasks:
 ...
 - [ ] `if ... else if ... else if` chains autograph into `tf.case` (maybe)
 - [ ] autograph inline expressions also (only functions can be autographed at the moment)
 - [x] nicer error messages warning about undefined symbols and unbalanced branches
 - [ ] a way to pass through additional options to `tf.while_loop` and others
